\doxysection{Référence du fichier include/parser.h}
\hypertarget{parser_8h}{}\label{parser_8h}\index{include/parser.h@{include/parser.h}}


Header file for command line parsing.  
...
\item 
int \mbox{\hyperlink{parser_8h_af3bac5e66a3099ac5a375c6abe1fb2c3}{trim}} (char \texorpdfstring{$\ast$}{*}str)
...
int \mbox{\hyperlink{parser_8h_a884ea722b2e695936cfa6b0ee00d11c3}{clean}} (char \texorpdfstring{$\ast$}{*}str)
...
int \mbox{\hyperlink{parser_8h_aa642f32e314f6164a0094c312f640f21}{separate\+\_\+s}} (char \texorpdfstring{$\ast$}{*}str, char \texorpdfstring{$\ast$}{*}s, size\+\_\+t max)
...
int \mbox{\hyperlink{parser_8h_a2ff627a35bb7947298fb5bc342731a57}{replace}} (char \texorpdfstring{$\ast$}{*}str, const char \texorpdfstring{$\ast$}{*}s, const char \texorpdfstring{$\ast$}{*}t, size\+\_\+t max)
...
int \mbox{\hyperlink{parser_8h_a23ba240bddff4480e06168d526be24ea}{substenv}} (char \texorpdfstring{$\ast$}{*}str, size\+\_\+t max)
...
int \mbox{\hyperlink{parser_8h_a248f7947bfc62206b93fa8fa24bc033c}{strcut}} (char \texorpdfstring{$\ast$}{*}str, char sep, char \texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}tokens, size\+\_\+t max)
...
int \mbox{\hyperlink{parser_8h_ac1f113b9a5d497bcc6853c555643c10c}{parse\+\_\+command\+\_\+line}} (\mbox{\hyperlink{structcommand__line__t}{command\+\_\+line\+\_\+t}} \texorpdfstring{$\ast$}{*}cmdl, const char \texorpdfstring{$\ast$}{*}line)
...
2025-\/26
\end{DoxyDate}
Définitions des fonctions d\textquotesingle{}analyse des lignes de commande. 

\doxysubsection{Documentation des fonctions}
\Hypertarget{parser_8h_a884ea722b2e695936cfa6b0ee00d11c3}\label{parser_8h_a884ea722b2e695936cfa6b0ee00d11c3} 
\index{parser.h@{parser.h}!clean@{clean}}
\index{clean@{clean}!parser.h@{parser.h}}
...
\end{DoxyReturn}
\Hypertarget{parser_8h_ac1f113b9a5d497bcc6853c555643c10c}\label{parser_8h_ac1f113b9a5d497bcc6853c555643c10c} 
\index{parser.h@{parser.h}!parse\_command\_line@{parse\_command\_line}}
\index{parse\_command\_line@{parse\_command\_line}!parser.h@{parser.h}}
...
\end{DoxyReturn}
Cette fonction remplace toutes les occurrences de la sous-\/chaîne {\itshape s} par la sous-\/chaîne {\itshape t} dans la chaîne {\itshape str}. Si le remplacement dépasse la taille maximale {\itshape max}, la fonction retourne -\/1. \Hypertarget{parser_8h_aa642f32e314f6164a0094c312f640f21}\label{parser_8h_aa642f32e314f6164a0094c312f640f21} 
\index{parser.h@{parser.h}!separate\_s@{separate\_s}}
\index{separate\_s@{separate\_s}!parser.h@{parser.h}}
...
int 0 en cas de succès, -\/1 en cas d\textquotesingle{}erreur (dépassement de taille).
\end{DoxyReturn}
Cette fonction ajoute un espace avant et après chaque occurrence d\textquotesingle{}un caractère de {\itshape s} dans {\itshape str}. Si l\textquotesingle{}ajout d\textquotesingle{}espaces dépasse la taille maximale {\itshape max}, la fonction retourne -\/1. \Hypertarget{parser_8h_a248f7947bfc62206b93fa8fa24bc033c}\label{parser_8h_a248f7947bfc62206b93fa8fa24bc033c} 
\index{parser.h@{parser.h}!strcut@{strcut}}
\index{strcut@{strcut}!parser.h@{parser.h}}
...
\end{DoxyReturn}
Cette fonction découpe la chaîne {\itshape str} en tokens en utilisant le caractère {\itshape sep} comme séparateur. Les tokens extraits sont stockés dans le tableau {\itshape tokens}. Si le nombre de tokens dépasse la taille maximale {\itshape max}, la fonction retourne -\/1. \Hypertarget{parser_8h_a23ba240bddff4480e06168d526be24ea}\label{parser_8h_a23ba240bddff4480e06168d526be24ea} 
\index{parser.h@{parser.h}!substenv@{substenv}}
\index{substenv@{substenv}!parser.h@{parser.h}}
...
int 0 en cas de succès, -\/1 en cas d\textquotesingle{}erreur (dépassement de taille).
\end{DoxyReturn}
Cette fonction remplace toutes les occurrences de variables d\textquotesingle{}environnement au format \$\+VAR ou \$\{VAR\} par leur valeur dans la chaîne {\itshape str}. Si une variable n\textquotesingle{}existe pas, elle est remplacée par une chaîne vide. Si le remplacement dépasse la taille maximale {\itshape max}, la fonction retourne -\/1. \Hypertarget{parser_8h_af3bac5e66a3099ac5a375c6abe1fb2c3}\label{parser_8h_af3bac5e66a3099ac5a375c6abe1fb2c3} 
